const Feature = () => (
  <>
    ...
    <section className="py-14 px-20 grid md:grid-cols-3 gap-8 text-center realtive inset-0 z-0">
      <div className="w-full py-4 px-2 sm:p-10 md:p-16  rounded-xl shadow-lg bg-gradient-to-b from-blue-400 via-blue-500 to-blue-900 text-white justify-center flex-col ">
      ...
      <div className="w-full py-4 px-2 sm:p-10 md:p-16 flex-col justify-center  rounded-xl shadow-purple-700/10 shadow-lg bg-gradient-to-b from-green-400 via-green-500 to-green-900 text-white ">
        <h3 className="font-semibold text-2xl mb-3 font-poppins">
          📑 ATS Friendly
        </h3>
        <p className="text-base leading-relaxed font-poppins">
      ...
      <div className="w-full py-4 px-2 sm:p-10 md:p-16 flex-col justify-center border rounded-xl shadow-md bg-gradient-to-b from-red-400 via-red-500 to-red-900 text-white">
        <h3 className="font-semibold text-2xl mb-3 font-poppins">
          📤 Export Options
        </h3>
        <p className="text-base leading-relaxed font-poppins">

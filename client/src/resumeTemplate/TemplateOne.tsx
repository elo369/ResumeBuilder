  ...
  >
    ...
    <div className="md:col-span-1 bg-gray-50 p-4 rounded-lg">
      <header className="pb-4 mb-4 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-600 mt-1">{collectData?.experience?.mainExperience?.jobTitle || "Professional Title"}</p>
      </header>
      ...
      <section className="mb-6">
        ...
        <div className="text-xs space-y-1">
          <p>
            <span className="font-semibold">Email:</span> {collectData?.personalInfo?.email}
          </p>
          <p>
            <span className="font-semibold">Phone:</span> {collectData?.personalInfo?.phoneNumber}
          </p>
          <p className="truncate">
            <span className="font-semibold">LinkedIn:</span> <a href={collectData?.personalInfo?.linkedin} target="_blank" className="text-blue-500 hover:underline">{collectData?.personalInfo?.linkedin}</a>
          </p>
          <p className="truncate">
            <span className="font-semibold">GitHub:</span> <a href={collectData?.personalInfo?.github} target="_blank" className="text-blue-500 hover:underline">{collectData?.personalInfo?.github}</a>
          </p>
        </div>
      </section>
      ...
      <section className="mb-6">
        ...
        <div className="text-sm space-y-2">
          <p>
            <span className="font-bold block">Languages:</span> {collectData?.technicalSkills?.language}
          </p>
          <p>
            <span className="font-bold block">Frameworks:</span> {collectData?.technicalSkills?.techFameworks}
          </p>
          <p>
            <span className="font-bold block">Dev Tools:</span> {collectData?.technicalSkills?.devTools}
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="text-sm">
          <p className="font-semibold">{collectData?.educationData?.education?.degree}</p>
          <p className="text-gray-700">
            {collectData?.educationData?.education?.college}
          </p>
          <p className="text-xs text-gray-500">
            {collectData?.educationData?.education?.startDate} -{" "}
            {collectData?.educationData?.education?.endDate} | {collectData?.educationData?.education?.locationInstitution}
          </p>
      ...
      <section>
        ...
        <div className="mb-4">
          <p className="font-semibold text-blue-700">
            ...
            <a href={collectData?.projects?.mainProject?.projectGithub} target="_blank" className="text-xs text-blue-500 ml-2 hover:underline">
              (GitHub)
            </a>
          </p>
